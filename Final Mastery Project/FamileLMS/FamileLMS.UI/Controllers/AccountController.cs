...
namespace FamileLMS.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())))
        {
            ...
            userValidator.AllowOnlyAlphanumericUserNames = false; //to allow email as username
        }
        ...
        public async Task<ActionResult> Register(LoginRegisterModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { UserName = model.Register.UserName, FirstName = model.Register.FirstName, LastName = model.Register.LastName, IsApproved = false, SuggestedAccountRole = model.Register.SuggestedAccountRole, GradeLevel = model.Register.GradeLevel };
